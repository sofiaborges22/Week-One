module Payroll
	def calculate_salary_hourly(hours_worked, hourly_rate)
      (hourly_rate * hours_worked).to_f
    end

	def calculate_salary_salary(base_salary)
		(base_salary / 52).to_f
	end

	def calculate_salary_multi(hours_worked, hourly_rate, base_salary)
		if hours_worked > 40
...
class HourlyEmployee < Employee
    ...
    def calculate_salary
    	calculate_salary_hourly(@hourly_rate, @hours_worked)
    end
end
...
class SalaryEmployee < Employee
	...
	def calculate_salary
		calculate_salary_salary(@salary)
	end
...
class MultiPaymentEmployee < Employee
	...
	def calculate_salary()
		calculate_salary_multi(@hours_worked, @base_salary, @hourly_rate)
	end
end
